...
////                            getCode(); // or getToken() depending on your requirement
////                            getToken();
////                            Intent i = new Intent(getApplicationContext(), myWrapped.class);
////                            startActivity(i);
////                            finish();
//                            // No need to start the next activity here
//                            // The next activity should be started after successful login in onActivityResult()
//
//                            // If already logged in, proceed to the next activity
//                            Intent i = new Intent(getApplicationContext(), myWrapped.class);
//                            startActivity(i);
//                            finish();
//                    }
